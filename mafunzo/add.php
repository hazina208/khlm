...
<?php
    ...
    //}
		if(isset($_POST['add']))
		{
			...
			$query="INSERT INTO ibada_mafundisho ( title,description,file) values(?,?,?)";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add Teachings</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Add Teachings Here </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3 class="header-title"><u><b><center>Teachings Details </u></b></center></h3>
                                            <div class="form-row">
                                            ...
                                            <h3 class="header-title"><u><b><center>Teachings </u></b></center></h3>
                                            ...
                                            <button type="submit" name="add" class="ladda-button btn btn-success" data-style="expand-right">Upload</button>
