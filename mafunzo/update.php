<?php
	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            if(file_exists('uploads/'.$_FILES['pic']['name']))
            {
                $filename=mysqli_real_escape_string($mysqli,$_FILES['pic']['name']);
                $err = "This File Already Exist:   ".$filename;
                
            }

            else
            {
                $query="UPDATE ibada_mafundisho SET title=?, description=?, file=? WHERE id = ?";
                ...
                if($stmt)
	            {
                    if(mysqli_real_escape_string($mysqli,$_FILES['pic']['name'] !=''))
                    {
                        ...
                        move_uploaded_file($tmpNamepic,'uploads/'.$pic_file);
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- ========== Left Sidebar Start ========== -->
            <?php include("../assets/inc/ibadamafundishosidebar.php");?>
            <!-- Left Sidebar End -->
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="ibada_mafundisho.php">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">TEACHINGS</a></li>
                                            <li class="breadcrumb-item ">Manage Teachings</li>
                                        </ol>
                                    </div>
                                    
                                    <h4 class="page-title">Update Teachings Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <a target="_blank"  href="uploads/<?php echo $row->file;?>" download="<?php echo $row->file;?>"><?php echo $row->file;?></a>
                                                    <input type="file"  name="pic" class="form-control">
                                                    <input type="hidden" name="old_pic" class="form-control" value="<?php echo $row->file; ?>">
                                            ...
                                            <button type="submit" name="update" class="ladda-button btn btn-success" data-style="expand-right">Update File</button>
