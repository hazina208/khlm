                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">TEACHINGS WINDOW</li>
                                            </ol>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                            <h4 class="header-title"><u><b><center>Play The Tachings Here</u></b></center></h4>
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <p class="">
                                                        ...
                                                        <h4 class=""> Video : <?php echo $row->file;?> </h4>
