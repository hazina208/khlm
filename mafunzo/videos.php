                                ...
                                <div class="col-12">
                                    <div class="card-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                            <h4 class="header-title"><u><b><center>IBADA NA MAFUNDISHO YA MUUMBA</u></b></center></h4>
                                                ...
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <button class="btn btn-secondary fa fa-play"><a target="_blank" href="playvideo.php?id=<?php echo $row->id;?>"  style="color:white;">&nbsp;Play</a></button>
                                                    <br>
                                                    <hr>
