...
<?php
    ...
    //}
		if(isset($_POST['add']))
		{
			...
			$query="INSERT INTO books ( title,description,file) values(?,?,?)";
            
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sss', $title,$description, $pic_file ); 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Add Books Here </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3 class="header-title"><u><b><center>Book Details </u></b></center></h3>
                                            <div class="form-row">
                                            ...
                                            <h3 class="header-title"><u><b><center>Book</u></b></center></h3>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="inputEmail4" class="col-form-label">Book</label>
                                            ...
                                            <button type="submit" name="add" class="ladda-button btn btn-success" data-style="expand-right">Add Book</button>
