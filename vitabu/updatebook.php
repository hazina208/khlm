<?php
	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            {
                $query="UPDATE books SET title=?, description=?, file=? WHERE id = ?";
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- ========== Left Sidebar Start ========== -->
            <?php include("../assets/inc/vitabusidebar.php");?>
            <!-- Left Sidebar End -->
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                            ...
                            {
                                $id=$mysqli -> real_escape_string($_GET['id']);
                                $ret="SELECT  * FROM books WHERE id=?";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" name="update" class="ladda-button btn btn-success" data-style="expand-right">Update Book</button>
