<?php
	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            if(file_exists('uploads/baba/'.$_FILES['pic']['name']))
            {
            ...
            {
                $query="UPDATE baba SET title=?, description=?, image=? WHERE id = ?";
                ...
                if($stmt)
	            {
                    ...
                    {
                        unlink("uploads/baba/".$old_image);
            
                        move_uploaded_file($tmpNamepic,'uploads/baba/'.$pic_file);
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">BABA HALISI</a></li>
                                            <li class="breadcrumb-item active">Manage BABA HALISI</li>
                                        </ol>
                                    </div>
                                    
                                    <h4 class="page-title">Update BABA HALISI Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <img src="uploads/baba/<?php echo $row->image;?>"  width="500px" height="" />
