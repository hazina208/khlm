                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Uzalishaji</a></li>
                                            <li class="breadcrumb-item active">Manage Uzalishaji</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Manage Uzalishaji Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                            try {
                                                $stmt = $pdo->prepare("SELECT * FROM uzalishaji ORDER BY id DESC");
                                                $stmt->execute();
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="../uploads/uzalishaji/<?= htmlspecialchars($row['image']) ?>" height="100" width="100" >
