                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Manage Clients Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                            try {
                                                $stmt = $pdo->prepare("SELECT * FROM upendo ORDER BY id DESC");
                                                $stmt->execute();
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="../uploads/upendo/<?= htmlspecialchars($row['image']) ?>" height="100" width="100" >
