                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-xl-7">
                                            <h4 class="header-title"><u><b><center>UPENDO ULIOPITILIZA/USIOBAGUA</center></b></u></h4>
                                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                                <?php
                                                // Use PDO to query the database
                                                $ret = "SELECT * FROM upendo";
                                                try {
                                                ...
                                                ?>
                                                    ...
                                                    <hr>
                                                    <p class="">
                                                        <img src="../uploads/upendo/<?php echo htmlspecialchars($row->image); ?>" width="700px" height="700" />
                                                    </p>
                                                    <hr>
                                                    <h4 class="mb-1"><?php echo htmlspecialchars($row->description); ?></h4>
                                                    <button class="btn btn-primary fa fa-download">
                                                        <a target="_blank" href="../uploads/upendo/<?php echo htmlspecialchars($row->image); ?>" download="<?php echo htmlspecialchars($row->image); ?>" style="color:white;">&nbsp;Download</a>
                                                    </button>
                                                    <br>
                                                    <hr>
                                                <?php 
