<?php
	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            if(file_exists('uploads/familia/'.$_FILES['pic']['name']))
            {
            ...
            {
                $query="UPDATE familiamoja SET title=?, description=?, image=? WHERE id = ?";
                ...
                if($stmt)
	            {
                    ...
                    {
                        unlink("uploads/familia/".$old_image);
            
                        move_uploaded_file($tmpNamepic,'uploads/familia/'.$pic_file);
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Familia</a></li>
                                            <li class="breadcrumb-item active">Manage Familia</li>
                                        </ol>
                                    </div>
                                    
                                    <h4 class="page-title">Update Familia Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <?php
                            ...
                            {
                                $id=$mysqli -> real_escape_string($_GET['id']);
                                $ret="SELECT  * FROM familiamoja WHERE id=?";
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <img src="uploads/familia/<?php echo $row->image;?>"  width="500px" height="" />
