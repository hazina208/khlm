<?php
	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            if(file_exists('uploads/kanisataifa/'.$_FILES['pic']['name']))
            {
            ...
            {
                $query="UPDATE kanisataifa SET title=?, description=?, image=? WHERE id = ?";
                ...
                if($stmt)
	            {
                    ...
                    {
                        unlink("uploads/kanisataifa/".$old_image);
            
                        move_uploaded_file($tmpNamepic,'uploads/kanisataifa/'.$pic_file);
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Amani</a></li>
                                            <li class="breadcrumb-item active">Manage Amani</li>
                                        </ol>
                                    </div>
                                    
                                    <h4 class="page-title">Update Amani Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <?php
                            ...
                            {
                                $id=$mysqli -> real_escape_string($_GET['id']);
                                $ret="SELECT  * FROM kanisataifa WHERE id=?";
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <img src="uploads/kanisataifa/<?php echo $row->image;?>"  width="500px" height="" />
