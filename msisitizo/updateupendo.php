<?php
	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            if(file_exists('../uploads/upendo/'.$_FILES['pic']['name']))
            {
            ...
            {
                $query="UPDATE upendo SET title=?, description=?, image=? WHERE id = ?";
                ...
                if($stmt)
	            {
                    ...
                    {
                        unlink("../uploads/upendo/".$old_image);
            
                        move_uploaded_file($tmpNamepic,'../uploads/upendo/'.$pic_file);
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <img src="../uploads/upendo/<?php echo $row->image;?>"  width="500px" height="" />
