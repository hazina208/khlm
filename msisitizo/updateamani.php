<?php
	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            if(file_exists('uploads/amani/'.$_FILES['pic']['name']))
            {
            ...
            {
                $query="UPDATE amani SET title=?, description=?, image=? WHERE id = ?";
                ...
                if($stmt)
	            {
                    ...
                    {
                        unlink("uploads/amani/".$old_image);
            
                        move_uploaded_file($tmpNamepic,'uploads/amani/'.$pic_file);
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                            ...
                            {
                                $id=$mysqli -> real_escape_string($_GET['id']);
                                $ret="SELECT  * FROM amani WHERE id=?";
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <img src="uploads/amani/<?php echo $row->image;?>"  width="500px" height="" />
