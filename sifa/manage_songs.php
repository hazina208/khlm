                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Manage Songs Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a target="_blank" href="playsong.php?id=<?php echo $row->id;?>" class="btn btn-success"><i class="mdi mdi-check-box-outline"></i> Play </a>  </td>
                                                    ...
                                                    <td>  
                                                        <a target="_blank" href="updatesongs.php?id=<?php echo $row->id;?>" class="btn btn-success"><i class="mdi mdi-check-box-outline"></i> update </a>  
                                                    ...
                                                    <td>
                                                        <form action="deletefile.php"  method="post">
                                                            ...
                                                            <button type="submit" name="delete_songs" class="btn btn-danger">Delete</button>
