	...
	if(isset($_POST['update']))
	{
        ...
        if($pic !='')
            ...
            if(file_exists('uploads/'.$_FILES['pic']['name']))
            {
                ...
                $err = "This Song Already Exist:   ".$filename;
                
            }

            else
            {
                $query="UPDATE sifa SET title=?, description=?, file=? WHERE id = ?";
                ...
                if($stmt)
	            {
		            ...
		            $success = "Songs Updated Successfully";
	            }
	            else {
		            $err = "Songs Not Updated";
	            }
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item ">Manage Songs</li>
                                        </ol>
                                    </div>
                                    
                                    <h4 class="page-title">Update Songs Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" name="update" class="ladda-button btn btn-success" data-style="expand-right">Update Song</button>
